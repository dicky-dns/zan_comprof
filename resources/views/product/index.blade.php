...
@section('content')
    <div class="page-hero" style="background-image: url({{ asset('assets/img/home/banner.png') }})">
        <div class="page-hero-content">
            <div class="container">
                <div class="row px-section">
                    <h1 class="page-title text-center text-light">Produk</h1>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="sticky-top px-4" style="top:90px; z-index: 20;">
                <ul class="list-group list-group-flush">
                    ...
                    @foreach ($kategoriall as $item)
                        <div class="list-group-item category-list list-group-item-action"
