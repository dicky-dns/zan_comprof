    ...
    <div id="pageSection">
        ...
        <div class="card mb-4 border-0">
            <div class="card-header d-flex flex-wrap justify-content-between bg-transparent py-3">
                <h5 class="font-weight-bold text-primary my-sm-auto m-0 mb-2">List Of Category</h5>
                <a href="{{ route('dashboard_kategori_tambah') }}"
    ...
    <script>
        $(document).ready(function() {
            const dttb = $('#datalist').DataTable({
                ...
                searchDelay: 500,
                ajax: {
                    url: '{!! route('dashboard_kategori_datatable') !!}',
                    type: 'get',
                    data: function(d) {
            ...
            $('body').on('click', '.deletebtn', function(e) {
                ...
                let url = "{{ route('dashboard_kategori_delete', ':id') }}";
