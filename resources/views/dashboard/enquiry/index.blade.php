    ...
    <div id="pageSection">
        ...
        <div class="card mb-4 border-0">
            <div class="card-header d-flex flex-wrap bg-transparent py-3">
                <h5 class="font-weight-bold text-primary my-sm-auto m-0 mb-2">Enquiry Message</h5>
            </div>
            <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            const dttb = $('#datalist').DataTable({
                ...
                searchDelay: 500,
                ajax: {
                    url: '{!! route('dashboard_enquiry_datatable') !!}',
                    type: 'get',
                    data: function(d) {
            ...
            $('body').on('click', '.viewbtn', function() {
                ...
                $('#mproduk').html(data.produk);
                $('#mnama').html(data.name);
                $('#memail').html(data.email);
                $('#mtelepon').html(data.phone);
            ...
            $('body').on('click', '#btnDelete', function(e) {
                ...
                let url = "{{ route('dashboard_enquiry_delete', ':id') }}";
            ...
            $('body').on('click', '#btnRead', function(e) {
                ...
                let url = "{{ route('dashboard_enquiry_update', ':id') }}";
                url = url.replace(':id', pesan_id);
